  ...
  return (
    <div id="price-estimator" className="flex h-screen w-screen">
      ...
      <div className="overflow-x-hidden w-screen">
        ...
        <div className=" grid-row flex w-screen ml-36 h-1/6 absolutefont-bold text-2xl font-mono p-4 text-black">
          <div className=" grid-col flex w-1/3 p-8 ml-6 z-30 text-black">
            FROM:
            <LocationDropDown selected={from} setSelected={setFrom} />
            TO:
            <LocationDropDown selected={to} setSelected={setTo} />
          </div>
          ...
          <div className=" grid-col flex  p-8 ml-6 text-black">
            <ImSearch size={36} />
          </div>
        </div>
