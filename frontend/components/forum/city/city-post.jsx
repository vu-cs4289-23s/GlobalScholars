      ...
      <span className="text-[16px] w-full h-full">
        <form className="flex flex-col align-middle">
          ...
          <FormInputSectionContainer>
            ...
            <SectionError>{titleError}</SectionError>
          </FormInputSectionContainer>
          {/* Post Review */}
          <FormInputSectionContainer>
            <FormInputSectionTitle>
            ...
            <SectionError>{contentError}</SectionError>
          </FormInputSectionContainer>
          {/* Post Tags */}
          <FormInputSectionContainer>
            <FormInputSectionTitle>
            ...
            <SectionError>{tagError}</SectionError>
          </FormInputSectionContainer>
          {/* Post Ratings */}
          <FormInputSectionContainer>
            <FormInputSectionTitle>
            ...
            <FormRatingContainer>
              <div className="m-2 flex text-center  align-middle">
                ...
                <div className="space-x-3 flex justify-center">
                  {affordabilityRating !== undefined &&
                  affordabilityRating >= 1 ? (
                    <FaDollarSign
                      size={30}
                      color={'rgb(11,155,29)'}
                      onClick={() => setAffordabilityRating(1)}
                    />
                  ) : (
                    <FaDollarSign
                      size={30}
                  ...
                  affordabilityRating >= 2 ? (
                    <FaDollarSign
                      size={30}
                      color={'rgb(11,155,29)'}
                      onClick={() => setAffordabilityRating(2)}
                    />
                  ) : (
                    <FaDollarSign
                      size={30}
                  ...
                  affordabilityRating >= 3 ? (
                    <FaDollarSign
                      size={30}
                      color={'rgb(11,155,29)'}
                      onClick={() => setAffordabilityRating(3)}
                    />
                  ) : (
                    <FaDollarSign
                      size={30}
