...
export default function LocationDropDown() {
  ...
  useEffect(() => {
    ...
    if (locationInfo[0] === undefined) {
      //if it is empty, get the location data
      dispatch(getAllLocationsAsyncAction());
    }
  }, []);
  return (
    <div className="relative top-16 w-56 h-full text-right">
      <Menu as="div" className="fixed inline-block  text-left">
        <div>
        ...
        >
          <Menu.Items className=" absolute max-h-96 right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none overflow-scroll">
